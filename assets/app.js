...
(function () {
  ...
  /* Journey strip: you-are-here (leader track of 6, builder track of 10) */
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-what-rag-is.html", "a2-anatomy.html", "a3-cost-quality.html",
           "a4-judge-a-rag.html", "a5-risk-governance.html", "a6-poc-to-prod.html"]
        : ["b1-embeddings.html", "b2-chunking.html", "b3-vector-databases.html",
           "b4-retrieval-basics.html", "b5-metadata-hybrid.html", "b6-reranking.html",
           "b7-grounding-citations.html", "b8-full-pipeline.html", "b9-evaluation.html",
           "b10-production.html"];
      var journey = document.createElement("div");
      journey.className = "journey";
      var jl = document.createElement("span");
      jl.className = "jlabel";
      jl.textContent = mx ? "Leader track" : "Builder track";
